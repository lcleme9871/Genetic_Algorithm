 ...
 */
public class CoverageReportParser extends DefaultHandler {
    ...
    public static Map<String, JavaClass> getCoverageData(File xml)
        ...
        CoverageReportParser handler = new CoverageReportParser();
    ...
    public void endElement(String uri, String localName, String qName)
        ...
        if (qName.equalsIgnoreCase("COUNTER")) {
            if (!currentJavaMethod.getName().equals("<init>")) {
                ...
                if (totalMissed > 0) {
                    if (totalCovered > 0) {
                        currentJavaMethod.setCoverageState(0);//partially covered
                    } else {
                        currentJavaMethod.setCoverageState(-1);//not covered
                    }
                } else {
                    currentJavaMethod.setCoverageState(1);//covered
                }
